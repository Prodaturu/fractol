...
=======
    ...
    // of the imaginary part is taken before squaring it. This results in a
    // fractal that looks like a ship on fire, hence the name.

>>>>>>> master
    void
    mandel_is_hooked(void *mlx, t_fractal *f) {
  f->xmin = -2.0;
  f->xmax = 1.0;
  f->ymin = -1.5;
  f->ymax = 1.5;
